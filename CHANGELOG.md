...
## Unreleased
### Changed
- [Patch] Added .pylintrc containing pylint config.

## v0.11.0 - 11.12.23
### Added
- [Minor] Parameter: Added new class Parameter as representation of a EDrive parameter.
- [Minor] ParameterHandler: Added write and read methods for Parameter objects.
### Changed
...
### Added
- [Patch] Added job to create gitlab release entry.

## v0.10.9 - 17.10.23
### Changed
- [Patch] Changes to enable backport to python3.9.
