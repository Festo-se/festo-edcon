# festo-edcon
`festo-edcon` is a python package which bundles modules to facilitate operation of Festo electric drives (currently via EtherNet/IP and Modbus) using PROFIDRIVE. Documentation can be found [here](https://festo-se.github.io/festo-edcon) and in the [examples](./examples) directory

[![PyPI Downloads](https://static.pepy.tech/personalized-badge/festo-edcon?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/festo-edcon)
...
```
## Usage
### [MotionHandler](https://festo-se.github.io/festo-edcon/features/edrive.html#edrive-motionhandler) - [`edrive.motion.MotionHandler`](https://festo-se.github.io/festo-edcon/edcon.edrive.html#module-edcon.edrive.motion_handler)
The motion module which aims to replicate the function set of the Siemens SinaPos function block (both using telegram 111).

### [ComModbus](https://festo-se.github.io/festo-edcon/features/edrive.html#commodbus) - [`edrive.com_modbus.ComModbus`](https://festo-se.github.io/festo-edcon/edcon.edrive.html#module-edcon.edrive.com_modbus)
The Modbus/TCP communication driver used for transmitting modbus traffic between host and drive.

### [ComEthernetip](https://festo-se.github.io/festo-edcon/features/edrive.html#comethernetip) - [`edrive.com_modbus.ComEthernetip`](https://festo-se.github.io/festo-edcon/edcon.edrive.html#module-edcon.edrive.com_ethernetip)
The EtherNet/IP communication driver used for transmitting EtherNet/IP traffic between host and drive.

### [Profidrive](https://festo-se.github.io/festo-edcon/features/profidrive.html) - [`profidrive`](https://festo-se.github.io/festo-edcon/edcon.profidrive.html#module-edcon.profidrive)
...
### [CLI](https://festo-se.github.io/festo-edcon/features/cli.html) - [`cli`](https://festo-se.github.io/festo-edcon/edcon.cli.html#module-edcon.cli)
